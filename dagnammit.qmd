...
* Global
  - [Which variables seem "important"](https://journal.r-project.org/archive/2020/RJ-2020-013/index.html) and [how do they impact the model's predictions?](https://journal.r-project.org/archive/2017/RJ-2017-016/index.html) 
* Local
...
## So what's the problem with causally interpreting predictive models?
...
## Correlation does not imply causation :roll_eyes: {.smaller}
